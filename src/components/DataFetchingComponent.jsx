...
const DataFetchingComponent = ({ onDataFetched }) => {
  ...
  useEffect(() => {
    axios.get('http://192.168.138.64:8080/api/temperature_sensor/temperature?timestamp=600h', { mode: 'no-cors' })
      .then(response => {
    ...
    axios.get('http://192.168.138.64:8080/api/temperature_sensor/humidity?timestamp=600h', { mode: 'no-cors' })
      .then(response => {
